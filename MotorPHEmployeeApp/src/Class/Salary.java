...
public class Salary {
    ...
    private double totalAllowance, totalDeductions, govermentContribution;
    ...
    public double calculateGross(double basicSalary, double totalAllowance) {
    ...
    public double calculateTotalDeductions(double govermentContribution, double withHoldingTax) {
            totalDeductions = govermentContribution + withHoldingTax;
            return totalDeductions;
    }
    
    public double calculateGovermentContribution(double sssContri, double philhealthContri, double pagibigContri) {
            govermentContribution = sssContri + philhealthContri + pagibigContri;
            return govermentContribution;
    }
